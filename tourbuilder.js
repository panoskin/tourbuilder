var TOURBUILDER = {
    ...
    createViewer: function(obj) {
        ...
        var id = obj.id
        var tour = obj.tour
        var url = (obj.domain) ? obj.domain : 'go.tourbuilder.com'
        ...
        iframe.className = "ps_TourBuilderTour";
    ...
    GA: function(param) {
	    ...
	    if (trackers.length === 0) return console.error('Tracking id for Google Analytics not found. Double check the ids you provided TourBuilder.')
        ...
        if (trackVisit) {
	        ...
	        var eventCategory = tourVisit.eventCategory || 'TourBuilder - ' + tourTitle
	        var eventAction = tourVisit.eventAction || 'Tour Visit'
	        var eventLabel = trackSceneView
	        var page = '/TourBuilder/' + tourTitle + '/Tour/Visit'
	        var pageTitle = tourVisit.pageTitle || 'TourBuilder - ' + tourTitle
        ...
        if (trackSceneView) {
	        ...
	        var eventCategory = sceneView.eventCategory || 'TourBuilder - ' + tourTitle
	        var page = '/TourBuilder/'+ tourTitle +'/Scene/View/' + trackSceneView
	        var pageTitle = sceneView.pageTitle || 'TourBuilder - ' + tourTitle
        ...
        if (trackImageGalleryView) {
	        ...
	        var eventCategory = imageGalleryViewSettings.eventCategory || 'TourBuilder - ' + tourTitle
	        var eventAction = imageGalleryViewSettings.eventAction || 'Image Gallery View'
	        var eventLabel = trackImageGalleryView
	        var page = '/TourBuilder/'+ tourTitle +'/Image/Gallery/View/' + trackImageGalleryView.replace('https://','')
	        var pageTitle = imageGalleryViewSettings.pageTitle || 'TourBuilder - ' + tourTitle
	        if (enabled) fireGA(trackers, eventCategory, eventAction, eventLabel, page, pageTitle)
        }
        ...
        if (trackMenuClick) {
	        ...
	        var eventCategory = menuClick.eventCategory || 'TourBuilder - ' + tourTitle
	        var eventAction = menuClick.eventAction || 'Menu Click'
	        var eventLabel = trackMenuClick
	        var page = '/TourBuilder/' + tourTitle + '/Menu/Click/' + trackMenuClick
	        var pageTitle = menuClick.pageTitle || 'TourBuilder - ' + tourTitle
	        if (enabled) fireGA(trackers, eventCategory, eventAction, eventLabel, page, pageTitle)
        }
        ...
        if (trackCarouselClick) {
	        ...
	        var eventCategory = carouselClick.eventCategory || 'TourBuilder - ' + tourTitle
	        var eventAction = carouselClick.eventAction || 'Carousel Click'
	        var eventLabel = trackCarouselClick
	        var page = '/TourBuilder/' + tourTitle + '/Carousel/Click/' + trackCarouselClick
	        var pageTitle = carouselClick.pageTitle || 'TourBuilder - ' + tourTitle
	        if (enabled) fireGA(trackers, eventCategory, eventAction, eventLabel, page, pageTitle)
        }
        ...
        if (trackConversion) {
	        ...
	        var eventCategory = conversions.eventCategory || 'TourBuilder - ' + tourTitle
	        var eventAction = conversions.eventAction || 'Conversion'
	        var eventLabel = trackConversion
	        var page = '/TourBuilder/' + tourTitle + '/Conversion/' + trackConversion
	        var pageTitle = conversions.pageTitle || 'TourBuilder - ' + tourTitle
	        if (enabled) fireGA(trackers, eventCategory, eventAction, eventLabel, page, pageTitle)
        }
    ...
    fullScreen: function(param) {
        ...
        if (e.getAttribute('data-attr-fullscreen')) TOURBUILDER.fireEvent(e, "exitFullScreen");
...
// Cross Frame Event from tourbuilder.com
